...
import {girl_controller} from './girl-controller.js';
import {kill_tracker} from './kill-tracker.js';
...
this._scene.add(plane);
  ...
  _LoadPlayer() {
    ...
    girl.AddComponent(new girl_controller.GirlController({
        detectionRange: 50,
        fleeSpeed: 2.0,
    }));
    ...
    player.AddComponent(new kill_tracker.KillTracker());
